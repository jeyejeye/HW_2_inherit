describe('Alist0 method init', function () {
...
describe('Alist0  method myPush', function () {
...
describe('Alist0  method myPop', function () {
    const testData = [
...
describe('Alist0  method myUnshift', function () {
...
describe('Alist0  method myShift', function () {
    const testData = [
        {arrA: [], expected1: [], expected2: undefined},
        {arrA: [5], expected1: [], expected2: 5},
...
describe('Alist0  method myRemove', function () {
    let obj = null;

    before(function() {
        const arrA = [0, 1, 2, 3, 4, 5, 6, 7, 8];
        obj = new Alist0().init(arrA);
    });
...
describe('Alist0  method myIsArray', function () {
